...
// <button style={{borderColor: "transparent", backgroundColor: "white",shadowColor: 'transparent'}}>
//   <img className="header-notifications" src="/img/notifications.svg" style = {{width: 18, height: 20}}/>
// </button>
